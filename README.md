# DMS
## Introduction
This DevOps repository has been created to manage the release process for the Customer Analytics Platform (CAP). 
CAP is an Azure SQL Managed Instance server which houses datasets from across the business for use by reporting teams.
